...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="*:tgroup" mode="hub:rm-redundant-cols">
    ...
    <xsl:variable name="rm-redundant-cols-namest">    
      <xsl:apply-templates select="$rm-redundant-cols-nameend" mode="hub:rm-redundant-cols-namest"/>
    </xsl:variable>
    <xsl:variable name="rm-redundant-small-cols-colname">
      <xsl:apply-templates select="$rm-redundant-cols-namest" mode="hub:rm-redundant-small-cols-colname"/>  
    </xsl:variable>
    <xsl:variable name="rm-redundant-small-cols-nameend">
      <xsl:apply-templates select="$rm-redundant-small-cols-colname" mode="hub:rm-redundant-small-cols-nameend"/>
    </xsl:variable>
    <xsl:apply-templates select="$rm-redundant-small-cols-nameend" mode="hub:rm-redundant-small-cols-namest"/>  
  </xsl:template>
  ...
  <xsl:template match="*:entry" mode="hub:rm-redundant-small-cols-colname hub:rm-redundant-small-cols-namest">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
    <xsl:copy>
      <xsl:apply-templates select="@* except (@spanname, @namest, @nameend)[not(empty($redundant-cols))]" mode="#current"/>
      <xsl:if test="not(empty($redundant-cols))">
        ...
        <xsl:choose>
          <xsl:when test="@colname or 
            ...
            <xsl:variable name="colname-colnum" 
                          select="if (@colname)
                                  then number($colname-corresponding-colspec/@colnum)-
                                       count($colname-corresponding-colspec/preceding-sibling::*:colspec[@colname=$redundant-cols])
                                  else ()"/>
  ...
  <xsl:template match="*:entry" mode="hub:rm-redundant-cols-nameend hub:rm-redundant-small-cols-nameend">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
    <xsl:copy>
      <xsl:apply-templates select="@* except (@spanname, @namest, @nameend)[not(empty($redundant-cols))]" mode="#current"/>
      <xsl:if test="not(empty($redundant-cols))">
  ...
  <xsl:template match="*:spanspec" mode="hub:rm-redundant-small-cols-colname hub:rm-redundant-small-cols-namest">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
    <xsl:variable name="namest-corresponding-colspec" 
  ...
  <xsl:template match="*:spanspec" mode="hub:rm-redundant-cols-nameend hub:rm-redundant-small-cols-nameend">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
    <xsl:variable name="namest-corresponding-colspec" select="ancestor::*:tgroup[1]/*:colspec[@colname = current()/@namest]" as="element(colspec)?"/>
    <xsl:variable name="nameend-corresponding-colspec" select="ancestor::*:tgroup[1]/*:colspec[@colname = current()/@nameend]" as="element(colspec)?"/>
    <xsl:variable name="collapsed" as="xs:boolean"
  ...
  <xsl:template match="*:tgroup/*:colspec" mode="hub:rm-redundant-cols-colname 
                                                 hub:rm-redundant-cols-nameend 
                                                 hub:rm-redundant-small-cols-colname 
                                                 hub:rm-redundant-small-cols-nameend">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
  ...
  <xsl:template match="*:tgroup/*:colspec" mode="hub:rm-redundant-cols-namest hub:rm-redundant-small-cols-namest">
    <xsl:param name="redundant-cols" tunnel="yes" as="xs:string*" select="()"/>
